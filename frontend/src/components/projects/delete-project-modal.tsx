...
export function DeleteProjectModal({ project, busy = false, onClose, onConfirm }: DeleteProjectModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4">
      ...
      >
        <div className="px-5 pt-5">
          ...
          <h2 id="delete-project-title" className="text-base font-semibold text-zinc-900 dark:text-zinc-100">
            Delete “{project.name}”?
          </h2>
          <p id="delete-project-copy" className="mt-1.5 text-xs leading-relaxed text-zinc-500 dark:text-zinc-400">
            This removes the project and its chat. Files stay in Library. This cannot be undone.
          </p>
        </div>
