  ...
  return (
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md dark:bg-[#0d0d0d]/95 select-none w-full">
      <div className="flex h-13 w-full items-center justify-between px-3 sm:px-5">
        ...
        {/* Rightmost Action Controls: Install App, Notifications Bell, Theme Toggle */}
        <div className="ml-auto flex items-center gap-1.5 sm:gap-2">
          {/* Install PWA Button with text */}
          <InstallHeaderButton />
          ...
          >
            ...
            >
              {resolvedTheme === "dark" ? (
                ...
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-zinc-700">
