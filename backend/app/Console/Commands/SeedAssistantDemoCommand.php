...
class SeedAssistantDemoCommand extends Command
{
    ...
    public function handle(AiServiceClient $ai): int
    {
        ...
        $seedDocs = [
            ...
            [
                'uri' => 'community://'.$community->id.'/asset/gfolder:1efl90laiuuy9hkuavai-s3uvczigjn34',
                'name' => 'UniPod Community Resources',
                'source_type' => 'markdown',
                'authority_tier' => KnowledgeAuthorityTier::VerifiedResource,
                'content' => "UniPod Community Resources\n\nhttps://drive.google.com/drive/folders/1eFl90laiuUy9HkuAVai-s3uVcZiGjN34\n\nOfficial UniPod community Google Drive hub containing core programme toolkits, templates, guidelines, and cohort learning materials.",
                'metadata' => [
                    'seeded_by' => 'zak:seed-assistant-demo',
                    'asset_kind' => 'folder',
                    'asset_identity' => 'gfolder:1efl90laiuuy9hkuavai-s3uvczigjn34',
                    'delivery' => 'google_drive',
                    'delivery_url' => 'https://drive.google.com/drive/folders/1eFl90laiuUy9HkuAVai-s3uVcZiGjN34',
                ],
            ],
            [
                'uri' => 'community://'.$community->id.'/asset/gdoc:1q1wsncblgit9s7nw-yegksopktiypm6n',
                'name' => 'UniPods METI AI Cohort 1 Info Pack',
                'source_type' => 'markdown',
                'authority_tier' => KnowledgeAuthorityTier::VerifiedResource,
                'content' => "UniPods METI AI Cohort 1 Info Pack\n\nhttps://drive.google.com/file/d/1q1wsNCblgit9s7nw-YeGKsOpkTIyPm6N/view\n\nComprehensive UniPods programme info pack with cohort guidelines, expectations, innovation milestones, and curriculum directory.",
                'metadata' => [
                    'seeded_by' => 'zak:seed-assistant-demo',
                    'asset_kind' => 'handbook',
                    'asset_identity' => 'gdoc:1q1wsncblgit9s7nw-yegksopktiypm6n',
                    'delivery' => 'google_drive',
                    'delivery_url' => 'https://drive.google.com/file/d/1q1wsNCblgit9s7nw-YeGKsOpkTIyPm6N/view',
                ],
            ],
            [
