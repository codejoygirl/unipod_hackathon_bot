...
def _system_prompt(mode: str, community_name: str | None, community_scope: str | None) -> str:
    ...
    base = (
        ...
        "When identifying who someone is, use their real full display name. "
        "When only referencing a known group member, write their plain name "
        "(the channel may convert it to a green @id mention when it has one). "
