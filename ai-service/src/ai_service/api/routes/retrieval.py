...
from ai_service.retrieval.hybrid import HybridRetrievalService
...
# Global singleton for the grounded synthesizer
_synthesizer = AnswerSynthesizer(chat_model=MockChatModel())
